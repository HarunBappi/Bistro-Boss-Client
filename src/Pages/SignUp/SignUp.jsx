        ...
        <div className="card bg-base-100 w-3/4 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            <div className="form-control">
              ...
              />
              {errors.name && (
                <span className="text-red-600 py-1">Name is required</span>
              )}
            </div>
            <div className="form-control">
              <label className="label">
              ...
              />
              {errors.photoURL && (
                <span className="text-red-600 py-1">Photo URL is required</span>
              )}
            </div>
            <div className="form-control">
              <label className="label">
              ...
              />
              {errors.email && (
                <span className="text-red-600 py-1">Email is required</span>
              )}
            </div>
            <div className="form-control">
              <label className="label">
              ...
              {errors.password?.type === "required" && (
                <span className="text-red-600 py-1">Password is required</span>
              )}
