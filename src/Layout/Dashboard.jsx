        ...
        <div className="w-64 min-h-screen bg-orange-400">
            <ul className="menu">
                ...
                <li><NavLink to="/dashboard/cart"> <FaShoppingCart></FaShoppingCart> My Cart ({cart.length})</NavLink></li> 
                 <li><NavLink to="/dashboard/review"> <MdReviews></MdReviews> Add a Reviews</NavLink></li> 
                  <li><NavLink to="/dashboard/bookings"> <TbBrandBooking></TbBrandBooking> My Bookings</NavLink></li>
